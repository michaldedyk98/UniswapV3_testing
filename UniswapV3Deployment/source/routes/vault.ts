...
router.post('/boosterEmergencyWithdraw', controller.boosterEmergencyWithdraw);
router.post('/boosterPause', controller.boosterPause);
router.post('/boosterUnpause', controller.boosterUnpause);
